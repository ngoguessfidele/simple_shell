...
/**
 * repeated_char- counts repetitions
 * @input: input stirng
 * @i: index
 * Return: repetitions
 */
...
/**
 * error_sep_op- syntax errors
 * @input: input string
 * @i: index
 * @last: last char read
 * Return: error index, or 0 when no error
 */
...
/**
 * first_char- index of first char
 * @input: input string
 * @i: index
